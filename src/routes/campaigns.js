...
router.post('/', authMiddleware, [
  ...
  try {
    ...
    // If an image URL is provided, store it and treat as image media
    if (imageUrl) {
      campaignData.mediaUrl = imageUrl;
      campaignData.mediaType = 'image';
      // Caption overrides the main message when sending image
      if (caption) {
        campaignData.imageCaption = caption;
      }
    }
